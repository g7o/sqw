...
$code=mysqli_real_escape_string($connection, $_POST['code']);
    if($code == 1){
        ...
        $tnumber=mysqli_real_escape_string($connection, $_POST['tnumber']);
...
function insertRegistration($connection,$vname,$nname,$uname,$sex,$mail,$birth,$street,$hnumber,$snumber,$tnumber,$plz,$city,$country,$picture,$password_check,$password){
 ...
 if($connection){
        switch($code){
            case 1: insertRegistration($connection,$vname,$nname,$uname,$sex,$mail,$birth,$street,$hnumber,$snumber,$tnumber,$plz,$city,$country,$picture,$password_check,$password);
                break;
            default: echo "Fehler";
                break;
        }
